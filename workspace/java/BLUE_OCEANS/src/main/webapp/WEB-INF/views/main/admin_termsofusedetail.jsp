					...
					<div class="container ">
						<div class="row g-1 d-flex justify-content-center">
							...
							<div class="row g-1 d-flex justify-content-end" style="padding-right: 150px;">
								<div class="col-auto">
									<input type="button" class="btn btn-sm btn-primary" value="목록" id="moveToList"> <input type="button" class="btn btn-sm btn-primary" value="수정" id="doEdit"> <input type="button" class="btn btn-sm btn-primary" value="삭제" id="doDelete">
								</div>
							</div>
